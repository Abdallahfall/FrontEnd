...
const Flight = () => {
  return (
    <div className="p-10">
      <div className="max-w-full bg-white flex flex-col  shadow-lg " style={{width:'550px'}}>
        <div className="flex flex-row items-baseline flex-nowrap bg-gray-100 p-1" style={{height:'40px'}}>
          ...
          <p className="ml-2 font-normal text-gray-500">Friday 1 oct</p>
        </div>
      ...
      <div class="flex flex-row place-items-center p-2" >
        <img src="delta1.png" alt="Delta Airlines" style={{height:'40px',width:'60px',marginRight:'40px'}}/>
        <div class="flex flex-col ml-2">
          <p class="text-xs text-gray-500 font-bold">Delta Airlines</p>
          <p class="text-xs text-gray-500">DL31</p>
          <div class="text-xs text-gray-500">2x25kg</div>
        </div>
      </div>
        </div>
      ...
      <div class="flex flex-col p-1">
        ...
        <p class="text-gray-500 text-sm"><span class="font-bold">NYC</span> New York</p>
        <p class="text-gray-500 text-sm">Etats Unis</p>
      </div>
      <div class="flex flex-col flex-wrap p-1 ml-2">
        <p class="font-bold">18:55</p>
        <p class="text-gray-500 text-sm"><span class="font-bold text-sm">DXB</span> Dubai</p>
        <p class="text-gray-500 text-sm">Émirats</p>
      </div>
    </div>
    ...
    <div class=" bg-gray-100 flex flex-row flex-wrap md:flex-nowrap justify-between items-baseline">
      <div class="flex mx-4 py-4 flex-row flex-wrap items-center">
        ...
        <div class="text-sm flex flex-col mx-3">
          ...
          <p class="font-bold text-sm mt-0 mb-0">$913.7</p>
      ...
      <div class="md:border-l-4 md:border-dotted flex flex-wrap items-center ml-0.2">
        <div class="text-sm mx-5 flex flex-col">
          <p class='mt-0 mb-0'>Flexible Ticket</p>
          <p class="font-bold mt-0 mb-0">$1207.43</p>
